...
from utils.logger import Logger,start_log,sde_log,train_log,set_log,sample_log,check_log
from utils.loader import load_data,load_ckpt,load_seed,load_device,load_ema_from_ckpt,load_sampling_fn,load_eval_settings,load_model_from_ckpt
from utils.graph_utils import adjs_to_graphs,init_flags,quantize,quantize_mol
from evaluation.stats import eval_graph_list
from utils.mol_utils import gen_mol, smiles_to_mols, load_smiles, canonicalize_smiles, mols_to_nx, mols_to_smiles
from utils.plot import save_graph_list,plot_graphs_list,save_fig
# from moses.
...
class Sampler():
    ...
    def sample(self):
        ...
        # -------- Save samples --------
        save_dir = save_graph_list(self.log_folder_name, self.config.data.data, gen_graph_list)
...
class Sampler_mol(object):
    ...
    def sample(self):
        ...
        with open(f'./data/{self.configt.data.data.lower()}.pkl', 'rb') as f:
